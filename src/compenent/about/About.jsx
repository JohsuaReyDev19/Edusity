  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>Embark on a transformative education journy with our
            university's comprehensive educatio programs. Our cutting-edge
            curroculum is design to empower students with the knowledge,
            skills, and experience needed to excel in the dynamic field of
            education 
        </p>s
        <p>
            With a focus on innovation, hands-on learning, and personalized
            mentorship, our programs prapare aspiring educators to make a
